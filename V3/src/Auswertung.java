...
public class Auswertung {
    ...
    public static void main() throws Exception {
        ...
        if (directoryListing != null) {
            String[] optionAs = { "Hund", "Apple", "Knoppers", "Pizza", "Meer", "Pepsi", "Schokoeis", "Zitroneneistee",
                    "McDonald's", "süßes Popcorn", "Friends" };
            String[] optionBs = { "Katze", "Android", "Hanuta", "Burger", "Berge", "Cola", "Vanilleeis",
                    "Pfirsicheistee", "Burger King", "salziges Popcorn", "HIMYM" };
